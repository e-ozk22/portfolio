        ...
        {!loading && user && (
          <section className="mb-4">
            <div className="flex items-center gap-x-4 mb-4">
              <h3 className="text-lg font-bold text-gray-900">レビュー履歴</h3>
              <button
                onClick={() => router.push("/books/new")}
                className="bg-pink-100 hover:bg-pink-200 text-pink-700 text-sm px-4 py-2 rounded-full transition-colors duration-200"
              >
                新しい本の投稿をする
              </button>
            </div>
